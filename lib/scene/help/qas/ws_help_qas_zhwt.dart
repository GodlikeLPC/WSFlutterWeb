  ...
  static List<WSHelpQAModel> listQAs() {
    return [
      ...
      WSHelpQAModel(
        ...
        answer: '一个账号可以支持**App和**案例网页版同时登录，但无法同时使用两个手机设备登录。',
      ),
      WSHelpQAModel(
        question: '如果解绑，更换手机号？',
        answer: '打开**App【我的】页面 -通过右上方图标进入【设置】页面-【账号设置】-【绑定手机】',
      ),
      WSHelpQAModel(
        question: '更换手机号之后会对账户原有的信息有什么影响？比如已购课程，**币，课程学习等方面',
        answer:
            '**App上数据不会影响。但如您曾在小鹅通**学院店铺购买过课程，在更换绑定手机号之后，需再次登录小鹅通账户并修改手机号，以便信息同步。',
      ),
      WSHelpQAModel(
        question: '如何修改个人信息？',
        answer: '打开**App【我的】页面-左上方头像及名字区域-【个人设置】，即可修改个人基本资料',
      ),
      WSHelpQAModel(
        question: '如何修改登录密码？',
        answer: '打开**App【我的】页面 -通过右上方图标进入【设置】页面-【账号设置】-【修改密码】',
      ),
    ];
  }
}
